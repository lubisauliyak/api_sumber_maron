...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if ($action == 'registrasi' && isset($_POST['nama']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['telepon']) && isset($_POST['username'])) {
        ...
        // Tidak ada data yg kosong
            ...
            // Menambah data akun_user yg baru
            $sql = "SELECT * FROM akun_user WHERE nama = '$nama' AND email = '$email' AND telepon = '$telepon' AND username ='$username'";
            ...
            // Data user belum terdaftar
                ...
                // Menambah akun_user yg baru
                $insert = "INSERT INTO akun_user (nama, email, password, telepon, username, created_at) VALUES ('$nama', '$email', '$password', '$telepon', '$username', current_timestamp())";
